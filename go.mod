module github.com/matt-FFFFFF/terraform-provider-alzlib
...
require (
	...
	github.com/matt-FFFFFF/alzlib v0.1.0
)
...
require (
	...
	github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/resources/armpolicy v0.5.0 // indirect
